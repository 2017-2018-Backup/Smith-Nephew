...
Friend Class armeddia
    ...
    Private Sub Form_LinkClose()
        ...
        If txtUnits.Text = "cm" Then
            BODVALID.g_nUnitsFac = 10 / 25.4
        Else
            BODVALID.g_nUnitsFac = 1
        End If
    ...
    Private Sub armeddia_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        BODVALID.g_nUnitsFac = 1 'Default to inches
        g_ShortArm = False
        g_NoElbowTape = False
    ...
    Private Sub PR_DrawAndCommitProfileEdits()
        ...
        For ii = 0 To 17
            If g_iChanged(ii) < 0 Or g_iChanged(ii) > 0 Then
                ...
                ARMDIA1.PR_PutTapeLabel(ii + 1, xyPt, ARMEDDIA1.fnDisplayToInches(g_nLengths(ii)), ARMEDDIA1.g_iMMs(ii), ARMEDDIA1.g_iGms(ii), ARMEDDIA1.g_iRed(ii))
                ProfileChanged = True
            End If
        Next ii
    ...
    Private Sub PR_DrawContracture()
        ...
        ARMDIA1.PR_DrawText("Remove For Contracture", xyContractTop, 0.125, 0)
    ...
    Private Sub PR_DrawLining()
        ...
        ARMDIA1.PR_DrawText(txtLining, xyElbow, 0.125, 0)
