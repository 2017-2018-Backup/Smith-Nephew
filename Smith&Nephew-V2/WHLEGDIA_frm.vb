...
Friend Class whlegdia
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (nValue > nFoldToProfileMinTol And xyPt2.X > xyFold.X) Then
            MsgBox("Check Profile to Fold distance! \n" +
        ...
        If (FootLess = False) Then
            ...
            PR_DrawLine(xyOBody, xyOtemplate)
            ...
            If (sToeStyle.Contains("Cut-Back") Or (sToeStyle.Equals("Soft Enclosed") And nFootLength <> 0 And (nAge > 10))) Then
                ...
                PR_DrawPoly(ptColl3)
            End If
            If (sToeStyle.Equals("Soft Enclosed") And nFootLength = True) Then
                If (nAge > 10) Then
                    nRightOffset = 2.25
                Else
                    nRightOffset = 1.75
        ...
        Else
            ...
            PR_DrawLine(xyOtemplate, xyOBody)
            ARMDIA1.PR_SetLayer("Notes")
