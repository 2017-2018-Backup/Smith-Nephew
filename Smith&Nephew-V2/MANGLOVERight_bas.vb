...
Error_Close:
    ...
    Sub PR_DrawShoulderFlaps(ByRef xyS As XY, ByRef xyE As XY, ByRef strFlaps As String, ByRef strCustFlapLength As String,
        ...
        PR_DrawMText(Strap, xyStrapText, 0)
        ...
        PR_DrawMText(strFlaps, xyFlapText1, 0)
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            If Not acBlkTbl.Has("GloveInsertU") Then
                ...
                If blkRecIdArw <> ObjectId.Null Then
                    ...
                    If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
                        blkRefOpenArw1.TransformBy(Matrix3d.Scaling(2.54, New Point3d(xyMGlvInsertion.X, xyMGlvInsertion.y, 0)))
                    End If
                    ...
                    If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
                        blkRefOpenArw2.TransformBy(Matrix3d.Scaling(2.54, New Point3d(xyMGlvInsertion.X, xyMGlvInsertion.y, 0)))
                    End If
                    '' Open the Block table record Model space for write
                    'Dim acBlkTblRec As BlockTableRecord
                    'acBlkTblRec = acTrans.GetObject(acBlkTbl(BlockTableRecord.ModelSpace), OpenMode.ForWrite)
                    'acBlkTblRec.AppendEntity(blkRefOpenArw)
                    blkTblRecGloveU.AppendEntity(blkRefOpenArw1)
                    blkTblRecGloveU.AppendEntity(blkRefOpenArw2)
                    'acTrans.AddNewlyCreatedDBObject(blkRefOpenArw, True)
                End If
                acBlkTbl.UpgradeOpen()
