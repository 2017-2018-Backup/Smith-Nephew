...
Module BODVALID
    ...
    Public g_sBodyBackNeck As String
    Public g_sFrontNeck As String

    Public g_nBodyUnderBreast As Double
    Public g_nBodyNipple As Double
    Public g_nBodyChest As Double
    ...
    Sub PR_GetValuesFromDialogue()
        ...
        If CType(MainForm.Controls("txtCir"), Object)(9).Text <> "" Then
            g_nShldToBreastGiven = fnDisplayToInches(Val(CType(MainForm.Controls("txtCir"), Object)(9).Text))
        End If

        If CType(MainForm.Controls("txtCir"), Object)(10).Text <> "" Then
            g_nUnderBreastCirGiven = fnDisplayToInches(Val(CType(MainForm.Controls("txtCir"), Object)(10).Text))
        End If

        If CType(MainForm.Controls("txtCir"), Object)(11).Text <> "" Then
            g_nNippleCirGiven = fnDisplayToInches(Val(CType(MainForm.Controls("txtCir"), Object)(11).Text))
        End If
