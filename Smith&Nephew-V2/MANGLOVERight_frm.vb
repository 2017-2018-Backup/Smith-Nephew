...
EXIT_OK:
    ...
    Private Sub PR_CreateDrawMacro(ByRef sFileName As String, ByRef iInsertSize As Short)
        ...
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "LFS")
        MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", "%Length")
        'Only add this data base field if this is an editable curve
        If g_RightExtendTo <> RIGHT_GLOVE_NORMAL Then MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "LFS")
        ...
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "ETS")
        MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", "%Length")
        'Only add this data base field if this is an editable curve
        If g_RightExtendTo <> RIGHT_GLOVE_NORMAL Then MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "ETS")
        ...
        Else
            ...
            ARMDIA1.PR_SetLayer("Template" & MANGLOVERight_bas.g_sSide)
            MANGLOVERight_bas.PR_DrawLine(xyPt1, xyPt2)
            MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "EOS")
            MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "EOS")
        End If
        ...
        ARMDIA1.PR_SetTextData(RIGHT_HORIZ_CENTER, RIGHT_BOTTOM_, RIGHT_CURRENT, RIGHT_CURRENT, RIGHT_CURRENT)
        MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "RIGHT_WRIST")
        ...
        If chkPalm.CheckState = 1 Or chkDorsal.CheckState = 1 Then
            ...
            If chkPalm.CheckState = 1 Then
                ...
                'Add REINFORCED text
                MANGLOVERight_bas.PR_DrawText("REINFORCED\nPALM", xyPt3, 0.1, 0)
            End If
        ...
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "PALMER")
        ARMDIA1.PR_NamedHandle("hPalmer") 'Save a HANDLE for later use

        MANGLOVERight_bas.PR_DrawMarker(xyRightLittle)
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "PALMER-WEB")
        If chkSlantedInserts.CheckState = 1 Then
            MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", Str(nInsert))
        Else
            MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", "0")
        End If

        MANGLOVERight_bas.PR_DrawMarker(xyRightRing)
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "DORSAL-WEB")
        If chkSlantedInserts.CheckState = 1 Then
            MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", Str(nInsert))
        Else
            MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", "0")
        ...
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "DORSAL")

        MANGLOVERight_bas.PR_DrawMarker(xyRightMiddle)
        MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", "OUTSIDE-WEB")
        If chkSlantedInserts.CheckState = 1 Then
            MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", Str(nInsert))
        Else
            MANGLOVERight_bas.PR_AddDBValueToLast("ZipperLength", "0")
        ...
        For ii = 2 To 6
            ...
            MANGLOVERight_bas.PR_AddDBValueToLast("Data", "RIGHT_PALM" & Trim(Str(ii)))
        Next ii
...
debugclose:
    ...
    Private Sub PR_DrawNormalThumb(ByRef nInsert As Double)
        ...
        MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "ThumbPalmCurve")
        ...
        PR_DrawThumbCurve(ThumbBottCurve, g_RightThumbTopCurve)
        MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "ThumbPieceSeam")
        ...
        'Draw thumb curve
        PR_DrawThumbCurve(ThumbBottCurve, g_RightThumbTopCurve)
        MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "ThumbPieceOutsideEdge")
    ...
    Private Sub PR_DrawTapeNotes(ByRef iVertex As Short, ByRef xyStart As MANGLOVERight_bas.XY, ByRef xyEnd As MANGLOVERight_bas.XY, ByRef nOffSet As Double, ByRef sZipperID As String)
        ...
        If sZipperID <> "" Then
            If sZipperID <> "EOS" Then MANGLOVERight_bas.PR_AddDBValueToLast("curvetype", "EOS")
            MANGLOVERight_bas.PR_AddDBValueToLast("Zipper", sZipperID)
        End If
        ...
        MANGLOVERight_bas.PR_AddDBValueToLast("Data", RightTapeNote(iVertex).sTapeText)

        'MMs
        MANGLOVERight_bas.PR_AddDBValueToLast("MM", Trim(Str(RightTapeNote(iVertex).iMMs)) & "mm")

        'Grams
        MANGLOVERight_bas.PR_AddDBValueToLast("Grams", Trim(Str(RightTapeNote(iVertex).iGms)) & "gm")

        'Reduction
        MANGLOVERight_bas.PR_AddDBValueToLast("Reduction", Trim(Str(RightTapeNote(iVertex).iRed)))

        'Circumference  in Inches and Eighths format
        iInt = Int(RightTapeNote(iVertex).nCir)
        MANGLOVERight_bas.PR_AddDBValueToLast("TapeLengths", Trim(Str(iInt)))

        nDec = (RightTapeNote(iVertex).nCir - iInt)
        If nDec > 0 Then
            iInt = ARMDIA1.round((nDec / RIGHT_EIGHTH) * 10) / 10
            If iInt <> 0 Then MANGLOVERight_bas.PR_AddDBValueToLast("TapeLengths2", Trim(Str(iInt)))
        End If
    ...
    Sub PR_GetDlgAboveWrist()
        ...
        Else
            ...
            For ii = 23 To 8 Step -1
                If Val(txtExtCir(ii).ToString()) > 0 Then
                    g_iLastTape = ii - 7
                    Exit For
                End If
            Next ii
