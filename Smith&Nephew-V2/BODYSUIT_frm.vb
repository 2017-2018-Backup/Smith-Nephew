...
Continue_Loop:
    ...
    End Sub
    Sub PR_DrawMText(ByRef sText As Object, ByRef xyInsert As BODYSUIT1.XY)
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        Dim strLayout As String = BlockTableRecord.ModelSpace
        If fnGetSettingsPath("DRAW_IN_LAYOUT").ToUpper().Equals("YES", StringComparison.InvariantCultureIgnoreCase) Then
    ...
    End Function
    Function FN_FitBiArcAtGivenLength(xyStart As BODYSUIT1.XY, aStart#, xyEnd As BODYSUIT1.XY, aEnd#, nLength#, nLengthTol#, nRadiusTol#, Mesh As BiArc) As Integer
        ...
        Else
            ...
            Else
                ...
                If g_sBodyLeftSleeve <> g_sBodyRightSleeve Then
                    ...
                    PR_DrawMText(sOther & " " & sAxillaText & Chr(10) & sThis & " " & sAxillaTextThis, xyText)
