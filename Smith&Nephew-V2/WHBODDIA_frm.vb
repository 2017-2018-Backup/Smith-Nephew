...
Friend Class whboddia
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        saveCutOutInfoToDWG(xyWHCutInsert, xyTOS, xyWaist, xyMidPoint, xyLargest, xyFold, xyFoldPanty, xyButtockArcCen, nFoldHt)
