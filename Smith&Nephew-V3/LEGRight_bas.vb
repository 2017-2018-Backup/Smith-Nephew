...
Module LEGRIGHT
    ...
    Public MainForm As LEGRight_frm
    ...
    Public g_iLastRightLegStyle As Short
    Public g_iRightLegStyle As Short

    Public g_sRightStyleString As String
    ...
    Public xyRightLegInsertion As XY
