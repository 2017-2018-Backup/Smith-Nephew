...
Friend Class whlegdia
    ...
    Private Sub PR_DrawFirstLeg()
        ...
        ''// Get CutOut details
        Dim xyOBody, xyTOS, xyWaist, xyMidPoint, xyLargest, xyFold, xyFoldPanty As XY
        ...
        If (SmallHeel) Then
            ...
            Dim nTest As Double = (nHeelR1 ^ 2 - nHeelD1 ^ 2 - nCalc ^ 2) / (-2 * nHeelD1 * nCalc)
            Dim nvad = System.Math.Acos(nTest)
