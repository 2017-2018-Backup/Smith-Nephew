...
Friend Class armeddia
    ...
    Private Sub PR_DrawContracture()
        ...
        ARMEDDIA1.PR_DrawText("Remove For Contracture", xyContractTop, 0.125, 0)
    ...
    Private Sub PR_DrawLining()
        ...
        ARMEDDIA1.PR_DrawText(txtLining.Text, xyElbow, 0.125, 0)
    ...
    Sub PR_DrawTapeLabel(ByRef nTape As Object, ByRef xyStart As ARMEDDIA1.XY, ByRef nLength As Object, ByRef nMM As Object, ByRef nGrm As Object, ByRef nRed As Object)
        ...
        ARMEDDIA1.PR_DrawText(Str(nGrm) & "gm", xyPt, nTextHt, 0)
        ...
        ARMEDDIA1.PR_DrawTextCenter(Trim(Str(nRed)), xyPt, nTextHt, 0)
        ARMEDDIA1.PR_DrawCircle(xyPt, 0.125)
    End Sub
End Class