Public Class WHZIPANK_frm
    ...
    Public g_sTemplate As String

    Private Sub WHZIPANK_frm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Hide()
