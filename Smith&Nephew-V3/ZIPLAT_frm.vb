Public Class ZIPLAT_frm
    ...
    Public g_bIsPanty As Boolean

    Private Sub ZIPLAT_frm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Hide()
        ...
        'Lenght List Combo
        If (g_bIsPanty) Then
            cboLengthList.Items.Add("Leg Tape")
        Else
        ...
        cboDistal.Items.Add("No Elastic")
        cboDistal.Items.Add("3/8" & Chr(34) & " Elastic")
        cboDistal.Items.Add("3/4" & Chr(34) & "Elastic")
        cboDistal.Items.Add("1½" & Chr(34) & "Elastic")
        cboDistal.Items.Add("No Elastic")
        cboDistal.SelectedIndex = 0
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        g_sElasticDistal = cboDistal.Text
        Me.Close()
    End Sub
