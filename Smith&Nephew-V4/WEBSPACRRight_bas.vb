...
Module WEBSPACRRight_bas
    ...
    Public g_sRightWebCurrentLayer As String
    Public g_nRightWebCurrTextHt As Object
    Public g_nRightWebCurrTextAspect As Object
    Public g_nRightWebCurrTextHorizJust As Object
    Public g_nRightWebCurrTextVertJust As Object
    Public g_nRightWebCurrTextFont As Object
    Public g_nRightWebCurrTextAngle As Object

    Public g_iRightWebInsertSize As Short
    Public g_sRightWebFileNo As String
    Public g_sRightWebSide As String
    Public g_sRightWebPatient As String

    Public g_nRightWebUnitsFac As Double
    Public g_RightWebExtendTo As Short
    Public g_iRightWebNumTapesWristToEOS As Short
    ...
    Public g_nRightWebPleats(4) As Double
    Public g_iRightWebFirstTape As Short
    Public g_iRightWebLastTape As Short
    Public g_iRightWebWristPointer As Short
    Public g_iRightWebEOSPointer As Short
    Public g_iRightWebNumTotalTapes As Short
    'UPGRADE_WARNING: Lower bound of array g_nRightWebCir was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
    Public g_nRightWebCir(17) As Double
    Public g_sRightWebPathJOBST As String
    Public g_RightTapesFound As Short
    Public g_nRightThumbWebDrop As Double

    Public MainForm As WEBSPACRRight_frm

    'UPGRADE_WARNING: Arrays in structure RightWebUlnarProfile may need to be initialized before they can be used. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"'
    Public RightWebUlnarProfile As curve
    'UPGRADE_WARNING: Arrays in structure RightWebRadialProfile may need to be initialized before they can be used. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"'
    Public RightWebRadialProfile As curve

    Public xyRightWebFold As xy
    Public xyRightTopThumbRad As xy
    Public xyRightBotThumbRad As xy
    'UPGRADE_WARNING: Lower bound of array xyRW was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
    Public xyRW(30) As xy
    ...
    Public xyRightWebT(10) As xy
    'UPGRADE_WARNING: Lower bound of array xyRN was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
    Public xyRN(3) As xy
    Public nRightTopThumbRad, nRightNotchRad, nRightBotThumbRad As Double

    Public Const g_sDialogID As String = "Web Spacers - Draw"

    Public Const g_sRightWebTapeText As String = " -6-4½ -3-1½  0 1½  3 4½  6 7½  910½ 1213½ 1516½ 1819½ 2122½ 2425½ 2728½ 3031½ 3334½ 36"


    Public Const RIGHT_WEB_SIXTEENTH As Double = 0.0625
    Public Const RIGHT_WEB_EIGHTH As Double = 0.125
    Public Const RIGHT_WEB_QUARTER As Double = 0.25
    ...
    Public Const RIGHT_WEB_ELBOW_TAPE As Short = 9
    ''--------Public Const ARM_PLAIN As Short = 0
    ''--------Public Const WEB_ARM_FLAP As Short = 1
    Public Const RIGHT_WEB_GLOVE_NORMAL As Short = 0
    Public Const RIGHT_WEB_GLOVE_ELBOW As Short = 1
    Public Const WEB_GLOVE_AXILLA As Short = 2
    Public Const RIGHT_GLOVE_PASTWRIST As Short = 3

    'UPGRADE_WARNING: Lower bound of array RightWebTapeNote was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
    Public RightWebTapeNote(WEB_NOFF_ARMTAPES) As TapeData
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acPoly As Polyline = New Polyline()
                ...
                Using rb As New ResultBuffer
                    ...
                    rb.Add(New TypedValue(DxfCode.ExtendedDataAsciiString, g_sRightWebFileNo + "Right"))
                    acPoly.XData = rb
                End Using
            End Using
    ...
    Sub PR_DrawLine(ByRef xyStart As xy, ByRef xyFinish As xy)
        ...
        End Using
    End Sub
    Sub PR_DrawText(ByRef sText As Object, ByRef xyInsert As xy, ByRef nHeight As Object, ByRef nAngle As Double, Optional ByRef bIsCenter As Boolean = False)
        'To the DRAFIX macro file (given by the global fNum).
        ...
        nWidth = nHeight * g_nRightWebCurrTextAspect
        Dim strLayout As String = BlockTableRecord.ModelSpace
        If fnGetSettingsPath("DRAW_IN_LAYOUT").ToUpper().Equals("YES", StringComparison.InvariantCultureIgnoreCase) Then
            strLayout = BlockTableRecord.PaperSpace
        End If
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acText As DBText = New DBText()
                ...
                If bIsCenter = True Then
                    ...
                    acText.AlignmentPoint = New Point3d(xyInsert.X + xyWebInsertion.X, xyInsert.Y + xyWebInsertion.Y, 0)
                End If
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
