...
Friend Class whlegdia
    ...
    Public Function PR_CloseWaistLeftLeg() As Boolean
        Dim Response As Short
        ...
        sCurrentValues = FN_ValuesString()
        If sCurrentValues <> g_sChangeChecker Then
            Response = MsgBox("Changes have been made, Save changes before closing", 35, "Waist - Left Leg")
            Select Case Response
                Case IDYES
                    Dim sDrawFile As String = fnGetSettingsPath("PathDRAW") & "\draw.d"
                    PR_CreateMacro_Save(sDrawFile)
    ...
    Private Sub cmdExtendLegTapes_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdExtendLegTapes.Click
        ...
        nValue = WHLEGDIA1.fnDisplayToInches(Val(Text1(ii).Text))
        ...
        Text1(ii + 1).Text = CStr(WHLEGDIA1.fnInchesToDisplay(nValue))
        labTapeInInches(ii + 1).Text = WHLEGDIA1.fnInchesToText(nValue)
	...
	Private Sub cmdShiftTapesDown_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdShiftTapesDown.Click
		...
		For ii = 29 To 1 Step -1
            ...
            nValue = WHLEGDIA1.fnDisplayToInches(Val(Text1(ii - 1).Text))
            labTapeInInches(ii).Text = WHLEGDIA1.fnInchesToText(nValue)
        Next ii
	...
	Private Sub Form_LinkClose()
		...
		If txtUnits.Text = "cm" Then
            WHLEGDIA1.g_nUnitsFac = 10 / 25.4
        Else
            WHLEGDIA1.g_nUnitsFac = 1
        End If

        'Foot Length
        nValue = WHLEGDIA1.fnDisplayToInches(Val(txtFootLength.Text))
        If nValue > 0 Then labFootLengthInInches.Text = WHLEGDIA1.fnInchesToText(nValue)
        ...
        For ii = 0 To 29
			...
			If nValue > 0 Then
                ...
                nValue = WHLEGDIA1.fnDisplayToInches(nValue)
                labTapeInInches(ii).Text = WHLEGDIA1.fnInchesToText(nValue)
            End If
		Next ii
		...
		g_nAnkleTape = 0
		g_nAnkleLen = 0
        g_nHeelLen = WHLEGDIA1.fnDisplayToInches(Val(Text1(5).Text))

        If (g_nHeelLen <> 0) And (g_nHeelLen < HEEL_TOL) Then
            g_nAnkleTape = 6 'Small heel Ankle at +1 1/2 tape
            g_nAnkleLen = WHLEGDIA1.fnDisplayToInches(Val(Text1(g_nAnkleTape).Text))
        Else
    ...
    Private Sub whlegdia_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        Try
            ...
            WHLEGDIA1.g_nUnitsFac = 1 'Default to inches
            txtLeg.Text = "Left"
            ''txtLeg.Text = g_stxtLeg
            Dim ii As Double
            For ii = 0 To 29
    ...
    Private Sub Text1_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Text1.Enter
        ...
        WHLEGDIA1.Select_Text_In_Box(Text1(Index))
    End Sub

    Private Sub Text1_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Text1.Leave
        Dim Index As Short = Text1.GetIndex(eventSender)
        Dim nValue As Double
        nValue = WHLEGDIA1.Validate_And_Display_Text_In_Box(Text1(Index), labTapeInInches(Index))
    ...
    Private Sub txtFootLength_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtFootLength.Enter
        WHLEGDIA1.Select_Text_In_Box(txtFootLength)
    End Sub
    ...
    Private Sub txtFootLength_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtFootLength.Leave
        Dim nValue As Double
        nValue = WHLEGDIA1.Validate_And_Display_Text_In_Box(txtFootLength, labFootLengthInInches)
    End Sub
    ...
    Private Sub txtFootPleat1_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtFootPleat1.Enter
        WHLEGDIA1.Select_Text_In_Box(txtFootPleat1)
    End Sub
    ...
    Private Sub txtFootPleat1_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtFootPleat1.Leave
        WHLEGDIA1.Validate_Text_In_Box(txtFootPleat1)
    End Sub
    ...
    Private Sub txtFootPleat2_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtFootPleat2.Enter
        WHLEGDIA1.Select_Text_In_Box(txtFootPleat2)
    End Sub
    ...
    Private Sub txtFootPleat2_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtFootPleat2.Leave
        WHLEGDIA1.Validate_Text_In_Box(txtFootPleat2)
    End Sub
    ...
    Private Sub txtTopLegPleat1_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtTopLegPleat1.Enter
        WHLEGDIA1.Select_Text_In_Box(txtTopLegPleat1)
    End Sub
    ...
    Private Sub txtTopLegPleat1_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtTopLegPleat1.Leave
        WHLEGDIA1.Validate_Text_In_Box(txtTopLegPleat1)
    End Sub
    ...
    Private Sub txtTopLegPleat2_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtTopLegPleat2.Enter
        WHLEGDIA1.Select_Text_In_Box(txtTopLegPleat2)
    End Sub
    ...
    Private Sub txtTopLegPleat2_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtTopLegPleat2.Leave
        WHLEGDIA1.Validate_Text_In_Box(txtTopLegPleat2)
    End Sub
    ...
    Private Sub Update_DDE_Text_Boxes()
        ...
        nAnkleTape = 0
        nAnkleLen = 0
        nHeelLen = WHLEGDIA1.fnDisplayToInches(Val(Text1(5).Text))

        If (nHeelLen <> 0) And (nHeelLen < HEEL_TOL) Then
            nAnkleTape = 6 'Small heel Ankle at +1 1/2 tape
            nAnkleLen = WHLEGDIA1.fnDisplayToInches(Val(Text1(nAnkleTape).Text))
        Else
        ...
        If nHeelLen = 0 And txtAnkleTape.Text = "" Then
            txtAnkleTape.Text = "-1 0 0 0 0 0 0 0"
        Else
            txtAnkleTape.Text = Str(nAnkleTape) & "1"
        End If
    ...
    Private Function Validate_Data() As Short
        ...
        If nFirstTape <= 5 Then
            nHeelLength = WHLEGDIA1.fnDisplayToInches(Val(Text1(5).Text))
        Else
            nHeelLength = 0
        End If
        ...
        If nHeelLength > 0 And (VB6.GetItemString(cboToeStyle, cboToeStyle.SelectedIndex) = "Self Enclosed" Or (VB6.GetItemString(cboToeStyle, cboToeStyle.SelectedIndex) = "Soft Enclosed" And Val(txtFootLength.Text) <> 0)) Then
            ...
            nFootLength = WHLEGDIA1.fnDisplayToInches(Val(txtFootLength.Text))
    ...
    Private Sub PR_DrawWaistLeg()
        ...
        Dim strBlkName As String = "WAISTLEFTLEG"
    ...
    Private Sub saveInfoToDWG()
        Try
            ...
            If (_sClass.GetXrecord("WaistLeftLeg", "WHLEFTDIC") IsNot Nothing) Then
                _sClass.RemoveXrecord("WaistLeftLeg", "WHLEFTDIC")
            End If
            ...
            _sClass.SetXrecord(resbuf, "WaistLeftLeg", "WHLEFTDIC")
        Catch ex As Exception
    ...
    Private Function PR_GetBlkAttributeValues() As Boolean
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            If WHBODDIA1.fnGetNumber(g_sLegStyle, 1) <> 2 Then
                If Not acBlkTbl.Has("WAISTLEFTLEG") Then
                    MsgBox("Can't find WAISTLEFTLEG symbol to update!", 16, "Waist - Dialogue")
                    Return False
                End If
                Dim acBlkTblRec As BlockTableRecord
                acBlkTblRec = acTrans.GetObject(acBlkTbl(strLayout), OpenMode.ForWrite)
                For Each objID As ObjectId In acBlkTblRec
                    ...
                    If TypeOf dbObj Is BlockReference Then
                        ...
                        If blkRef.Name = "WAISTLEFTLEG" Then
        ...
        If WHBODDIA1.fnGetNumber(g_sLegStyle, 1) <> 2 Then
            If sPressure = "" Or sPressure = " " Then
                MsgBox("Figure LEFT Leg before drawing", 0, "First Leg Drawing")
                Return False
            End If
        End If
    ...
    Sub PR_MakeXY(ByRef xyReturn As XY, ByRef X As Double, ByRef y As Double)
        ...
        xyReturn.Y = y
    End Sub
    Sub PR_DrawLine(ByRef xyStart As XY, ByRef xyFinish As XY, Optional ByRef bIsDistalLine As Boolean = False, Optional ByRef bIsNotScale As Boolean = False)
        'To the DRAFIX macro file (given by the global fNum).
    ...
    Private Function readCutOutInfo(ByRef xyOBody As XY, ByRef xyTOS As XY, ByRef xyWaist As XY, ByRef xyMidPoint As XY, ByRef xyLargest As XY,
                               ByRef xyFold As XY, ByRef xyFoldPanty As XY, ByRef nFoldHt As Double) As Boolean
        ...
        Try
            ...
            If (resbuf IsNot Nothing) Then
                ...
                '    strValue = arr(10).Value
                '    xyCO_WaistBott.X = WHBODDIA1.fnGetNumber(strValue, 1)
                '    xyCO_WaistBott.Y = WHBODDIA1.fnGetNumber(strValue, 2)
                'End If
            End If
        Catch ex As Exception
        ...
        Return bIsExist
    End Function
    Private Sub readStretchInfo(ByRef bIsStretch As Boolean)
        Try
            Dim _sClass As New SurroundingClass()
            Dim resbuf As New ResultBuffer
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        PR_DrawFirstLeg()
    End Sub
    Public Sub PR_DrawWaistFirstLeg()
        'Initialize globals
        QQ = Chr(34) 'Double quotes (")
        NL = Chr(13) 'New Line
        CC = Chr(44) 'The comma (,)
        ...
        PR_DrawFirstLeg()
    End Sub
    Private Sub PR_DrawFirstLeg()
        ''--------------File Name : WHLG1ORG.D --------------------
        If PR_GetBlkAttributeValues() = False Then
            Exit Sub
        End If
        If WHBODDIA1.fnGetNumber(g_sLegStyle, 1) >= 5 Then
            PR_DrawChapStyleLeftLeg()
            Exit Sub
        End If
        ''For Brief Style
        If WHBODDIA1.fnGetNumber(g_sLegStyle, 1) = 2 Then
            PR_DrawBriefStyleLeftLeg()
            Exit Sub
        End If
        ''Dim FootLess As Boolean = WHLEGDIA1.fnDisplayToInches(Val(Text1(5).Text))
        Dim FootLess As Boolean = True
        If Val(Text1(5).Text) > 0 Then
            FootLess = False
        End If
        Dim ii, nFoldHt As Double
        ''// Get CutOut details
        Dim xyOBody, xyTOS, xyWaist, xyMidPoint, xyLargest, xyFold, xyFoldPanty, xyThigh, xyCO_WaistBott As XY
        Dim BodyFound As Boolean = False
        If readCutOutInfo(xyOBody, xyTOS, xyWaist, xyMidPoint, xyLargest, xyFold, xyFoldPanty, nFoldHt) = False Then
            MsgBox("No BODY found!, draw Cut-Out and try again.", 16, "Waist - Leg Dialog")
            Exit Sub
        End If
        BodyFound = True
        'Dim nStretch As Double = 0
        'Dim bIsStretch As Boolean = False
        'readStretchInfo(bIsStretch)
        'If bIsStretch = True Then
        '    nStretch = 0.3175
        'End If


        ''// Establish leg start position relative to the body
        Dim nLegStartHt, nBodyLegTapePos, nValue, nFirstTape, nLastTape As Double
        ...
        nFootPleat1 = WHLEGDIA1.fnDisplayToInches(Val(txtFootPleat1.Text))
        nFootPleat2 = WHLEGDIA1.fnDisplayToInches(Val(txtFootPleat2.Text))
        nTopLegPleat1 = WHLEGDIA1.fnDisplayToInches(Val(txtTopLegPleat1.Text))
        nTopLegPleat2 = WHLEGDIA1.fnDisplayToInches(Val(txtTopLegPleat2.Text))
        ...
        readStretchInfo(bIsStretchExist)
        ...
        xyOtemplate.X = xyOBody.X - (nLegStartHt * nInchToCM)
        ...
        PR_AddDBValueToLast("OriginID", txtFileNo.Text + txtLeg.Text + "Origin")
        ...
        PR_AddDBValueToLast("ID", txtFileNo.Text + txtLeg.Text + "Fold")
        ...
        Dim nLtLastHeel As Double = WHLEGDIA1.fnDisplayToInches(Val(Text1(5).Text))
        ...
        ''-------------Added for #65 and #77 in issue list---------------
        Dim bIsStretch As Boolean = False
        readStretchInfo(bIsStretch)
        While (nn <= nLoop)
            ...
            If (FNGetTape(nn)) Then
                ...
                End If
                xyTmp.X = xyPt1.X
                ''nTapeLen = FNRound(FNDecimalise(FNGetTape(nn)) * WHLEGDIA1.g_nUnitsFac)
                nTapeLen = FNDecimalise(FNGetTape(nn)) * WHLEGDIA1.g_nUnitsFac
                ...
                ''----------PR_DrawText(WHLEGDIA1.fnInchesToText(nTapeLen), xyText, 0.125, 0, 1)
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
            ...
            If ((nn = 7) Or (FootLess = True And nn = nFirstTape + 2)) Then
                ...
                nTxtX = xyPt1.X
                Dim sText As String = "Left Leg  " + Chr(10)
                ''// Data
        ...
        nTapeLen = FNDecimalise(FNGetTape(nAnkleTape)) * WHLEGDIA1.g_nUnitsFac
        ...
        nTapeLen = FNDecimalise(FNGetTape(nHeelTape)) * WHLEGDIA1.g_nUnitsFac
        ...
        nAnkleMTapeLen = FNDecimalise(FNGetTape(nAnkleMTape)) * WHLEGDIA1.g_nUnitsFac
        ...
        Dim strLayer As String = "TemplateLeft"
        ...
        If (FootLess = False) Then
            ...
            While (ii <= 2)
                ...
                ptColl.Add(New Point3d(xyPlr1.X, xyPlr1.Y, 0))
                ii = ii + 1
            End While
            aPrevAngle = 90
        ...
        While (nn <= nLastTape)
            ...
            End If
            'If (ShortLeg And nn = nFirstTape) Then
            '    xyPt1 = xyTmp
            'End If
            'If (ShortLeg And nn = nFirstTape + 1) Then
            '    xyPt2 = xyTmp
            'End If
            'If (ShortLeg And nn = nFirstTape + 2) Then
            '    xyPt3 = xyTmp
            'End If
            ...
            If (nFabricClass = 2 And FootLess = False) Then
                ...
                ''--------------PR_DrawText(WHLEGDIA1.fnInchesToText(nTapeLen), xyText, 0.1, 0, 1)
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
        ...
        If (BodyFound) Then
            ...
            ''//Hit 92% mark for Panties And w4oc Panty leg 
            If (nLegStyle = 1 Or (nLegStyle = 3 And FootLess = True) Or (nLegStyle = 4 And FootLess = True)) Then
                ''AddVertex(xyFoldPanty) '' // We must hit this point For panties
                ptColl.Add(New Point3d(xyFoldPanty.X, xyFoldPanty.Y, 0))
            Else
                If (xyTmp.Y < xyFold.Y) Then
                    ''AddVertex(xyFold)
            ...
            ptColl.Add(New Point3d(xyMidPoint.X, xyMidPoint.Y, 0))
            ''AddVertex(xyWaist)
            ptColl.Add(New Point3d(xyWaist.X, xyWaist.Y, 0))
            If (Val(sTOSCir) <> 0) Then
                ''AddVertex(xyTOS) ''	//* Fax 6.Sept.94, Item
                ptColl.Add(New Point3d(xyTOS.X, xyTOS.Y, 0))
            End If
        End If
        '' EndPoly()
        ''PR_DrawPoly(ptColl)
        ...
        Dim ptNewColl As Point3dCollection = ptColl
        ...
        PR_AddDBValueToLast("ID", txtFileNo.Text + txtLeg.Text + "LegCurve")
        ''Changed for #134 in the issue list
        ''saveLegCurveInfo(ptColl)
        saveLegCurveInfo(ptNewColl)
        ''saveLegCurvePointsForStump(ptColl)
        ...
        End If
        ''// Check distance of fold to leg profile using xyPt1 And xyPt2 stored above
        ''// This Is an approximate check only
        nValue = System.Math.Sqrt(FN_CalcLength(xyFold, xyPt2) ^ 2 - (FN_CalcLength(xyPt1, xyPt2) / 2) ^ 2)

        Dim nFoldToProfileMinTol As Double = 0.75
        If (nValue > nFoldToProfileMinTol And xyPt2.X > xyFold.X) Then
            MsgBox("Check Profile to Fold distance! " + Chr(10) +
                   "Distance may be more than " + Str(nFoldToProfileMinTol), 16, "Waist - Leg Dialog")
        End If
        Dim sTmp As String = ""
        If (FootLess = False) Then
            ''// Draw foot points
            ...
            ''g_xyHeel = xyAnkle
            PR_AddDBValueToLast("ID", txtFileNo.Text + txtLeg.Text + "Ankle")
            ...
            PR_AddDBValueToLast("HeelID", txtFileNo.Text + txtLeg.Text + "Heel")
            ...
            PR_AddDBValueToLast("ID", txtFileNo.Text + txtLeg.Text + "AnkleM")
            PR_AddDBValueToLast("Data", sTmp)
            If (nAge > 10) Then
            ...
            ''AddEntity("line", xyOBody, xyOtemplate)
            PR_DrawLine(xyOBody, xyOtemplate, False, True)
            ...
            If (sToeStyle.Equals("Soft Enclosed") And nFootLength <> 0) Then
                ...
                sFootLabel = WHLEGDIA1.fnInchesToText(nRightOffset) + Chr(34) + " Soft Enclosed"
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
        ...
        Else
            ...
            PR_AddDBValueToLast("ID", txtFileNo.Text + txtLeg.Text + "DistalClosingLine")
            PR_MakeXY(xyToeSeam, xyOtemplate.X, xyOtemplate.Y)
            ''PR_DrawLine(xyLastTape, xyText)
            ''AddEntity("line", xyOtemplate, xyOBody)
            PR_DrawLine(xyOtemplate, xyOBody, False, True)
            ARMDIA1.PR_SetLayer("Notes")
            ...
            PR_DrawTextAsSymbol(xySymbol, txtFileNo.Text + txtLeg.Text + "PantyElasticNote", sFootLabel, 90)
            ''xyToeSeam = xyOtemplate  ''// dummy, used To draw tramlines As below
            PR_AddDBValueToLast("ID", txtFileNo.Text + txtLeg.Text + "PantyElasticNote")
            PR_AddDBValueToLast("Data", sFootLabel)
        End If

        ''// Seam TRAM Lines
        ''AddEntity("line", xyToeSeam.x, xyOBody.Y + nSeam + 0.5, xyOBody.X, xyOBody.Y + nSeam + 0.5)
        PR_MakeXY(xyStart, xyToeSeam.X, xyOBody.Y + nSeam + 0.5)
        PR_MakeXY(xyEnd, xyOBody.X, xyOBody.Y + nSeam + 0.5)
        PR_DrawLine(xyStart, xyEnd, False, True)
        ''AddEntity("line", xyToeSeam.x, xyOBody.Y + nSeam, xyOBody.X, xyOBody.Y + nSeam)
        PR_MakeXY(xyStart, xyToeSeam.X, xyOBody.Y + nSeam)
        PR_MakeXY(xyEnd, xyOBody.X, xyOBody.Y + nSeam)
        PR_DrawLine(xyStart, xyEnd, False, True)
    ...
    Function FNDecimalise(ByRef nDisplay As Double) As Double
        ...
        If WHLEGDIA1.g_nUnitsFac <> 1 Then
    ...
    Private Sub PR_DrawArc(ByRef xyCen As XY, ByRef nRad As Double, ByRef nStartAng As Double, ByRef nDeltaAng As Double)
        ...
        End Using
    End Sub
    Private Sub saveLegCurveInfo(ByRef ptColl As Point3dCollection)
        Try
            Dim _sClass As New SurroundingClass()
            If (_sClass.GetXrecord("LegCurve", "LEGCURVEDIC") IsNot Nothing) Then
                _sClass.RemoveXrecord("LegCurve", "LEGCURVEDIC")
            End If
            Dim resbuf As New ResultBuffer
            Dim ii As Double
            For ii = 0 To ptColl.Count - 1
                Dim sString As String = Str(ptColl(ii).X) + " " + Str(ptColl(ii).Y)
                resbuf.Add(New TypedValue(CInt(DxfCode.Text), sString))
            Next ii
            _sClass.SetXrecord(resbuf, "LegCurve", "LEGCURVEDIC")
        Catch ex As Exception
        End Try
    End Sub
    'To Draw Spline
    ...
    Sub PR_AddDBValueToLast(ByRef sDBName As String, ByRef sDBValue As String)
        ...
        End Using
    End Sub
    Private Function saveLegCurvePointsForStump(ByRef ptColl As Point3dCollection) As Boolean
        Try
            Dim _sClass As New SurroundingClass()
            If (_sClass.GetXrecord("LegCurveStump", "LEGCURVESTUMPDIC") IsNot Nothing) Then
                _sClass.RemoveXrecord("LegCurveStump", "LEGCURVESTUMPDIC")
            End If
            Dim resbuf As New ResultBuffer
            Dim ii As Double
            For ii = 0 To ptColl.Count - 1
                ...
                resbuf.Add(New TypedValue(CInt(DxfCode.Text), sString))
            Next ii
            _sClass.SetXrecord(resbuf, "LegCurveStump", "LEGCURVESTUMPDIC")
        Catch ex As Exception
        End Try
    End Function
    ...
    Private Sub PR_DrawWaistLegStump()
        ...
        If (readLegCurveInfo(ptCurveColl) = False) Then
        ...
        ''Dim sTapeLengths As String = txtTapeLengths.Text
        ''Dim nFirstTape As Double = Val(txtFirstTape.Text)
        ''Dim nLastTape As Double = Val(txtLastTape.Text)
        ...
        Dim nTapeLen As Double = ARMDIA1.round(FNDecimalise(FNGetTape(nFirstTape)) * WHLEGDIA1.g_nUnitsFac)
        Dim nSeam As Double = 0.1875
    ...
    End Sub
    Sub PR_DrawWaistClosedArrow(ByRef xyPoint As XY, ByRef nAngle As Object, Optional ByRef bIsNeedToScale As Boolean = False)
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        Dim strLayout As String = BlockTableRecord.ModelSpace
        If fnGetSettingsPath("DRAW_IN_LAYOUT").ToUpper().Equals("YES", StringComparison.InvariantCultureIgnoreCase) Then
    ...
    Private Function PR_GetInsertionPoint(ByRef xyInsert As XY) As Boolean
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        ...
        PR_MakeXY(xyInsert, ptStart.X, ptStart.Y)
        Return True
    End Function
    Private Sub PR_DrawChapStyleLeftLeg()
        ''----------------------WHLGCORG.D-----------------------------
        ...
        ''// At Minus Ankle ( ie -3 or -1.5 Tape)
        ''nAnkleMTapeLen = FNRound(FNDecimalise(FNGetTape(nAnkleMTape)) * nUnitsFac)
        Dim nAnkleMTapeLen As Double = FNDecimalise(FNGetTape(nAnkleMTape)) * WHLEGDIA1.g_nUnitsFac
        nLength = nAnkleM20Len / 20 * nAnkleMTapeLen
        nRedStep = nAnkleM20Len / (20 * 8)
        nLength = nLength + ((nAnkleMTmpltReduction - nAnkleMChartReduction) * nRedStep)
        xyAnkleM.Y = xyOtemplate.Y + nSeam + nLength
        ...
        End If
    End Sub
    Private Function readCutOutInfoForBrief(ByRef xyThigh As XY, ByRef xyCO_WaistBott As XY) As Boolean
        Dim bIsExist As Boolean = False
        Try
            Dim _sClass As New SurroundingClass()
            Dim resbuf As New ResultBuffer
        ...
        Return bIsExist
    End Function
    Private Sub PR_DrawBriefStyleLeftLeg()
        ...
        If readCutOutInfo(xyOBody, xyTOS, xyWaist, xyMidPoint, xyLargest, xyFold, xyFoldPanty, nFoldHt) = False Then
            ...
            Exit Sub
        End If
        If readCutOutInfoForBrief(xyThigh, xyCO_WaistBott) = False Then
            MsgBox("No BODY found!, draw Cut-Out and try again.", 16, "Waist - Leg Dialog")
            Exit Sub
        End If
        BodyFound = True
        ...
        ''AddVertex(xyMidPoint);
        ''AddVertex(xyWaist);
        ''If (Value("scalar", sTOSCir)!= 0) Then AddVertex (xyTOS);	
        ''EndPoly() ;

        Dim ptColl As Point3dCollection = New Point3dCollection
        ptColl.Add(New Point3d(xyThigh.X, xyThigh.Y, 0))
        ptColl.Add(New Point3d(xyFoldPanty.X, xyFoldPanty.Y, 0))
        ptColl.Add(New Point3d(xyLargest.X, xyLargest.Y, 0))
        ptColl.Add(New Point3d(xyMidPoint.X, xyMidPoint.Y, 0))
        ptColl.Add(New Point3d(xyWaist.X, xyWaist.Y, 0))
        ...
        ''SetData("TextHeight", 0.1);
        ARMDIA1.PR_SetLayer("Notes")
        Dim nTxtY As Double = xyOtemplate.Y - 0.5
        Dim nTxtX As Double = xyOtemplate.X + 2

        'If (StringCompare(sLeg, "Left")) Then sText = "Left Leg\n  " ;
        'Else sText = "Right Leg\n  ";
        Dim sText As String = "Left Leg" + Chr(10)
        ''// Work Order Info
        sText = sText + txtPatientName.Text + Chr(10) + "  " + sWorkOrder
        If (nFabricClass = 0 And sFabric.Equals("") = False) Then
            sText = sText + Chr(10) + " " + StringMiddle(sFabric, 5, sFabric.Length - 4)
        Else
            sText = sText + Chr(10) + " " + sFabric
        End If
        ...
        If (Val(sTOSCir) = 0) Then
            ...
            PR_MakeXY(xyText, nTxtX, nTxtY)
            PR_DrawLine(xyCO_WaistBott, xyText)
            ''hEnt = AddEntity("marker", "closed arrow", xyCO_WaistBott, 0.5, 0.125, Calc("angle", xyCO_WaistBott, nTxtX, nTxtY))
            Dim bIsScale As Boolean = False
            If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
                bIsScale = True
            End If
            PR_DrawWaistClosedArrow(xyCO_WaistBott, FN_CalcAngle(xyCO_WaistBott, xyText), bIsScale)
            ''AddEntity("text", "TAPER FRONT", nTxtX, nTxtY )
            PR_DrawText("TAPER FRONT", xyText, 0.125, 0, 4)
            nTxtY = nTxtY - 0.15
            ''AddEntity("text", "     TO HERE    ", nTxtX, nTxtY)
            PR_MakeXY(xyText, nTxtX, nTxtY)
            PR_DrawText("     TO HERE    ", xyText, 0.125, 0, 4)
        End If
        If chkStump.Checked = True Then
            PR_DrawWaistLegStump()
        End If
