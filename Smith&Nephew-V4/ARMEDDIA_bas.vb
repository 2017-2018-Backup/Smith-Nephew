...
Module ARMEDDIA1
    ...
    Sub PR_DrawPoly(ByRef Profile As curve)
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acPoly As Polyline = New Polyline()
                ...
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
                    ...
                    acPoly.TransformBy(Matrix3d.Scaling(2.54, New Point3d(Profile.X(1), Profile.y(1), 0)))
                End If
        ...
        End Using
    End Sub
    Sub PR_DrawText(ByRef sText As Object, ByRef xyInsert As XY, ByRef nHeight As Object, ByRef nAngle As Double, ByRef xyBase As XY)
        'To the DRAFIX macro file (given by the global fNum).
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acText As DBText = New DBText()
                ...
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
                    ...
                    acText.TransformBy(Matrix3d.Scaling(2.54, New Point3d(xyBase.X, xyBase.y, 0)))
                End If
    ...
    Sub PR_DrawSpline(ByRef PointCollection As Point3dCollection, Optional ByVal bIsSetXDATA As Boolean = False)
        ...
        End Using
    End Sub
    Sub PR_DrawTextCenter(ByRef sText As Object, ByRef xyInsert As XY, ByRef nHeight As Object, ByRef nAngle As Double, ByRef xyBase As XY)
        Dim nWidth As Object
        nWidth = nHeight * g_nCurrTextAspect
        ...
        End Using
    End Sub
    Sub PR_DrawCircle(ByRef xyCen As XY, ByRef nRadius As Object, ByRef xyBase As XY)
        Dim strLayout As String = BlockTableRecord.ModelSpace
        If fnGetSettingsPath("DRAW_IN_LAYOUT").ToUpper().Equals("YES", StringComparison.InvariantCultureIgnoreCase) Then
            strLayout = BlockTableRecord.PaperSpace
        End If
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acCirc As Circle = New Circle()
                ...
                If fnGetSettingsPath("UNITS").ToUpper().Equals("CM", StringComparison.InvariantCultureIgnoreCase) Then
                    ...
                    acCirc.TransformBy(Matrix3d.Scaling(2.54, New Point3d(xyBase.X, xyBase.y, 0)))
                End If
