...
Public Class BODYMAIN_frm
    ...
    Private Sub BODYMAIN_frm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        If g_bIsCloseDlg = True Then
            g_bIsCloseDlg = False
            Exit Sub
        End If
        If frmBody.IsDisposed() = False Then
            If frmBody.PR_CloseBodyDialog() = False Then
                e.Cancel = True
                Exit Sub
            End If
        End If
        ...
        If frmLeg.IsDisposed() = False Then
            If frmLeg.PR_CloseBodyLeg() = False Then
                e.Cancel = True
                Exit Sub
            End If
        End If
