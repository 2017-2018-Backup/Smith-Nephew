...
Public Class MANGLOVEMAIN_frm
    ...
    Private Sub MANGLOVEMAIN_frm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        If g_bIsCloseDlg = True Then
            g_bIsCloseDlg = False
            Exit Sub
        End If
        If ManGlvLeft.IsDisposed() = False Then
            If ManGlvLeft.PR_CloseLeftGlvDialog() = False Then
                e.Cancel = True
                Exit Sub
            End If
        End If
        If ManGlvRight.IsDisposed() = False Then
            If ManGlvRight.PR_CloseRightGlvDialog() = False Then
                e.Cancel = True
                Exit Sub
            End If
        End If
