...
Module MANGLOVERight_bas
    ...
    Public MainForm As MANGLOVERight_frm

    Public g_iRightInsertValue(6) As Double
    Public g_RightFinger(5) As RightFinger 'Includes thumb
    Public g_nRightFingerPIPCir(5) As Double
    Public g_nRightFingerDIPCir(5) As Double
    Public g_nRightFingerLen(5) As Double
    Public g_nRightWeb(4) As Double
    Public g_RightOnFold As Short
    Public g_RightMissingFingers As Short
    Public g_RightMissing(5) As Short
    Public g_nRightPalm As Double
    Public g_nRightWrist As Double
    Public g_iRightFINGER_CHART(5) As Short
    Public g_nRightFINGER_FIGURE(5) As Double
    Public g_nRightPALM_FIGURE As Double
    Public g_nRightWRIST_FIGURE As Double
    Public g_iRightThumbStyle As Short
    Public g_iRightInsertStyle As Short
    Public g_iInsertSize As Short
    Public g_RightCalculatedExtension As Short
    Public g_RightFusedFingers As Short
    Public g_iRightThumbWebDrop As Short

    Public xyRightDatum As XY
    Public xyRightLittle As XY
    Public xyRightLFS As XY
    Public xyRightRing As XY
    Public xyRightIndex As XY
    Public xyRightMiddle As XY
    Public xyRightThumb As XY
    Public xyRightPalm(6) As XY
    Public xyRightPalmThumb(5) As XY
    Public xyRightT(10) As XY

    Public g_iGms(16) As Short
    Public g_iMMs(16) As Short
    Public g_iRed(16) As Short
    ''--------Public g_nRightCir(16) As Double
    Public g_nRightCir(1, RIGHT_NOFF_ARMTAPES) As Double
    Public g_nRightPleats(4) As Double
    Public g_iMGlvRightFirstTape As Short
    ''---------------Public g_iLastTape As Short
    Public g_iRightWristPointer As Short
    Public g_iRightEOSPointer As Short
    Public g_iRightNumTotalTapes As Short
    Public g_iRightNumTapesWristToEOS As Short
    Public g_RightEOSType As Short
    Public g_iRightPressure As Short
    Public g_iRightInsertOtherGlv As Short
    Public g_RightOnFoldOtherGlv As Short
    Public g_RightDataIsCalcuable As Short
    Public g_RightPrintFold As Short
    Public g_RightExtendTo As Short

    'Flaps
    Public g_nRightStrapLength As Double
    Public g_nFrontStrapLength As Double
    Public g_nRightCustFlapLength As Double
    Public g_nWaistCir As Double
    Public g_sRightFlapType As String
    Public g_iRightFlapType As Short

    'Curves
    ''--------Public g_FingerThumbBlend As Curve
    Public g_RightThumbTopCurve As RightBiArc
    ''--------Public UlnarProfile As Curve
    ''---------Public RadialProfile As curve
    Public RightTapeNote(RIGHT_NOFF_ARMTAPES) As TapeData


    Public Const g_sDialogID As String = "Glove Dialogue"
    'Misc
    Public Const RIGHT_EIGHTH As Double = 0.125
    Public Const RIGHT_SIXTEENTH As Double = 0.0625
    Public Const QUARTER As Double = 0.25
    'Tapes etc
    Public Const RIGHT_PALM As Short = 2
    Public Const RIGHT_WRIST As Short = 1
    ...
    Public Const RIGHT_LOW_MODULUS As Short = 160
    Public Const RIGHT_HIGH_MODULUS As Short = 340
    Public Const NOFF_MODULUS As Short = 19

    Public Const RIGHT_NOFF_ARMTAPES As Short = 16
    Public Const RIGHT_ELBOW_TAPE As Short = 9
    Public Const RIGHT_ARM_PLAIN As Short = 0
    Public Const RIGHT_ARM_FLAP As Short = 1
    Public Const RIGHT_GLOVE_NORMAL As Short = 0
    Public Const RIGHT_GLOVE_ELBOW As Short = 1
    Public Const RIGHT_GLOVE_AXILLA As Short = 2

    Public g_iRightModulusIndex As Short
    ...
    'Fingers
    Public Const RIGHT_DIP As Short = 1
    Public Const RIGHT_PIP As Short = 2
    Public Const RIGHT_THUMB As Short = 3
    Public Const RIGHT_THUMB_LEN As Short = 2
    Public Const RIGHT_FINGER_LEN As Short = 1

    Public Const RIGHT_HORIZ_CENTER As Short = 2
    Public Const TOP_ As Short = 8
    Public Const RIGHT_BOTTOM_ As Short = 32
    Public Const LEFT_ As Short = 1
    Public Const RIGHT_RIGHT_ As Short = 4
    Public Const RIGHT_VERT_CENTER As Short = 16
    Public Const RIGHT_CURRENT As Short = -1

    Public Const g_sRightTapeText As String = " -6-4½ -3-1½  0 1½  3 4½  6 7½  910½ 1213½ 1516½ 1819½ 2122½ 2425½ 2728½ 3031½ 3334½ 36"
    Public xyMGlvInsertion As XY
    Public g_idRgtLastZipper As ObjectId
    ...
    End Sub
    Function FN_GetRightReduction(ByRef iGrams As Object) As Short
        ...
        '        g_iRightModulusIndex
        '        g_iPowernet()
        '
        If g_iRightModulusIndex < 1 Or g_iRightModulusIndex > NOFF_MODULUS Then
            FN_GetRightReduction = -1
            Exit Function
        End If
        ...
        Select Case iGrams
            Case Is <= g_iPowernet(g_iRightModulusIndex, 1)
                FN_GetRightReduction = 10

            Case Is >= g_iPowernet(g_iRightModulusIndex, 23)
                FN_GetRightReduction = 32

            Case Else
                'Return value closest
                iPrevValue = 0
                For ii = 1 To 23
                    iValue = g_iPowernet(g_iRightModulusIndex, ii)
                    If iValue > iGrams Then Exit For
                    iPrevValue = iValue
                Next ii

                If System.Math.Abs(iGrams - iPrevValue) < System.Math.Abs(iGrams - iValue) Then
                    FN_GetRightReduction = ii + 8
                Else
                    FN_GetRightReduction = ii + 9
                End If

        End Select
    End Function
    Function FN_GetRightGrams(ByVal iReduction As Short) As Short
        'Function that looks up the "Powernet" grams / tension chart
        ...
        FN_GetRightGrams = g_iPowernet(g_iRightModulusIndex, (iReduction - 10) + 1)
    End Function
    Sub PR_LoadReductionCharts(ByRef sFabric As String)
        ...
        Dim jj, fChart, iModulus, ii, nn As Short
        ...
        While Not EOF(fChart) And ii <= NOFF_ARM_RED
            ...
            If Mid(sLine, 1, 1) <> "#" And sLine <> "" Then
                Dim nTest1 As Double = Val(Mid(sLine, 5, 2))
                Dim nTest2 As Double = Val(Mid(sLine, 7, 1))
                nArmRed(1, ii) = Val(Mid(sLine, 5, 2)) + (Val(Mid(sLine, 7, 1)) * 0.125)
                jj = 1
                For nn = 9 To 34 Step 4
                    nTest1 = Val(Mid(sLine, nn, 2))
                    nTest2 = Val(Mid(sLine, nn + 2, 1))
                    jj = jj + 1
        ...
        sLine = ""
    End Sub
    Function FN_RightFigureFinger(ByRef iSelect As Short, ByRef nFingerCir As Double, ByRef iInsert As Short) As Double
        'procedure to return the Figured circumference of a finger
        '
        ' iSelect    a constant, one of DIP, PIP, RIGHT_THUMB
        ' nFingerCir Dimension in inches in
        '            1" >= nFingerCir <= 4.825"
        ' iInsert    Insert range to be used
        '            1 >= iNinsert <= 6
        '            iInsert = 1, use looked up figure
        '            iInsert > 1, add 2 to DIP & PIP, add 1 to RIGHT_THUMB
        '                         to looked up figure
        '            iInsert = 6, subtract 1 from DIP, PIP, RIGHT_THUMB
        '                         to looked up figure
        '
        ...
        FN_RightFigureFinger = 0#
        If iSelect < RIGHT_DIP Or iSelect > RIGHT_THUMB Then Exit Function
        ...
        If iInsert = 6 Then
            iValue = iValue + 1
        ElseIf iSelect = RIGHT_THUMB Then
        ...
        FN_RightFigureFinger = iValue * 0.0625
    End Function
    Function FN_RightFigureTape(ByRef iSelect As Short, ByRef nTapeCir As Double) As Double
        ...
        'Check data is within range
        FN_RightFigureTape = 0#
        If iSelect < RIGHT_WRIST Or iSelect > TAPE_NINE Then Exit Function
        ...
        If nTapeCir > 12.875 Then
            ...
            FN_RightFigureTape = nArmRed(iSelect, iIndex) + (iAdditional * 0.125)
        Else
            iIndex = (((nTapeCir - 3.5) * 1000) \ 125) + 1
            'Look up valueFN_RightFigureTape
            FN_RightFigureTape = nArmRed(iSelect, iIndex)
            End If
    End Function
    Function FN_LengthWristToEOS() As Double
        ...
        nLen = 0
        Select Case g_RightExtendTo
            Case RIGHT_GLOVE_NORMAL
                ''----- "- 1" is added on 10-11-2018
                For ii = 1 To g_iRightNumTapesWristToEOS - 1
                ...
                If nLen = 0 Then
                    ...
                    nLen = 0.625
                End If
            Case RIGHT_GLOVE_ELBOW
                For ii = 1 To g_iRightNumTapesWristToEOS - 1
                    nSpace = 1.375
                    If ii = 1 And g_nRightPleats(1) <> 0 Then nSpace = fnDisplayToInches(g_nRightPleats(1))
                    If ii = 2 And g_nRightPleats(2) <> 0 Then nSpace = fnDisplayToInches(g_nRightPleats(2))
                    If ii = g_iRightNumTapesWristToEOS - 2 And ii <> 1 And g_nRightPleats(3) <> 0 Then nSpace = fnDisplayToInches(g_nRightPleats(3))
                    If ii = g_iRightNumTapesWristToEOS - 1 And ii <> 2 And g_nRightPleats(4) <> 0 Then nSpace = fnDisplayToInches(g_nRightPleats(4))
                    nLen = nLen + nSpace
                Next ii

            Case RIGHT_GLOVE_AXILLA
                For ii = 1 To g_iRightNumTapesWristToEOS - 1
                    nSpace = 1.375
                    If ii = 1 And g_nRightPleats(1) <> 0 Then nSpace = fnDisplayToInches(g_nRightPleats(1))
                    If ii = 2 And g_nRightPleats(2) <> 0 Then nSpace = fnDisplayToInches(g_nRightPleats(2))
    ...
    Sub PR_MakeXY(ByRef xyReturn As XY, ByRef X As Double, ByRef y As Double)
        ...
        xyReturn.y = y
    End Sub
    Function FN_RightFigureLength(ByRef iSelect As Short, ByRef nLen As Double) As Double
        'Procedure to return the Figured length of a finger
        'or thumb
        '
        ' iSelect    A constant, one of RIGHT_THUMB or FINGER
        ...
        'Check data is within range
        FN_RightFigureLength = 0#
        If iSelect <> RIGHT_THUMB_LEN And iSelect <> RIGHT_FINGER_LEN Then Exit Function
        If nLen >= 1 And nLen <= 3.875 Then
            'Convert nLen to an index
            'Note integer division \
            iIndex = (((nLen - 1) * 1000) \ 125) + 1
            'Look up value
            FN_RightFigureLength = nLengthRed(iSelect, iIndex)
        ElseIf nLen < 1 Then
            'Return given value unmodified
            FN_RightFigureLength = nLen
        ElseIf nLen > 3.875 And iSelect = RIGHT_THUMB_LEN Then
            FN_RightFigureLength = nLen - 0.125
        ElseIf nLen > 3.875 And iSelect = RIGHT_FINGER_LEN Then
            FN_RightFigureLength = nLen - 0.25
        End If
    End Function
    ...
    End Function
    Sub PR_CalcRightFingerBlendingProfile(ByRef xyTop As XY, ByRef xyBottom As XY, ByRef xyFinger As XY, ByRef Digit As RightFinger, ByRef ReturnProfile As curve, ByRef xyThumbPalm As XY)
...
MissingFingers:
        ...
        End If
    End Sub
    Public Function FN_RightBiArcCurve(ByRef xyStart As XY, ByRef aStart As Double, ByRef xyEnd As XY, ByRef aEnd As Double, ByRef Profile As RightBiArc) As Short
        'Procedure to fit two arcs with a common tangent
        'between two points at the tangent angles specified.
        'Returning a RightBiArc curve.
        '
        'InputArm
        ...
        '
        'Output
        '        Profile     RightBiArc in (XY System)
        '
        'Restrictions:-
        ...
        '
        'Notes:-
        'The RightBiArc is a structure that is used to represent
        'the curve.
        '
        '        Type RightBiArc
        '                xyStart     as XY
        ...
        'Works OK for some special cases (cf RIGHT_THUMB Curves)
        'GG 22.Mar.96
        '
        '
        ...
        'Using the calculated radi, create RightBiArc Curve
...
Error_Close:
    ...
    Function FN_ValidateExtensionData() As String
        ...
        iNoPleats = 0
        For ii = 1 To 4
            If g_nRightPleats(ii) > 0 Then iNoPleats = iNoPleats + 1
        Next ii
        If iNoPleats + 1 > g_iRightNumTapesWristToEOS Then
        ...
        ''-----If g_nRightCir(g_iRightWristPointer) <> g_nRightWrist Then
        'If g_nRightCir(1, g_iRightWristPointer) <> g_nRightWrist Then
        '    sError = sError & "Wrist tape of the glove and the extension are different!" & nL
        'End If

        'Check on style D flaps
        If g_RightEOSType = RIGHT_ARM_FLAP And InStr(1, g_sRightFlapType, "D") > 0 And g_nWaistCir = 0 Then
    ...
    End Function
    Sub PR_DisplayRightTextInches(ByRef ctlText As System.Windows.Forms.Control, ByRef ctlCaption As System.Windows.Forms.Control)
    ...
    Sub PR_CalculateExtension(ByRef xyWristUlnar As XY, ByRef xyWristRadial As XY, ByRef nInsert As Double,
        ...
        If g_iRightNumTapesWristToEOS = 0 Or g_iRightNumTapesWristToEOS = 1 Then
        ...
        If g_RightExtendTo = RIGHT_GLOVE_NORMAL Then
            ...
            '
            '
            UlnarProfile.n = g_iRightNumTapesWristToEOS
            UlnarProfile.X(1) = xyWristUlnar.X
            UlnarProfile.y(1) = xyWristUlnar.y

            RadialProfile.n = g_iRightNumTapesWristToEOS
            RadialProfile.X(1) = xyWristRadial.X
            ...
            'any more
            iStartTape = 2
            iLastTape = g_iRightNumTapesWristToEOS + 1
            ...
            For ii = iStartTape To iLastTape
                ...
                '
                'NB use of 1/2 scale
                ''-------nFiguredValue = FN_RightFigureTape(ii + 1, g_nRightCir(ii))
                nFiguredValue = FN_RightFigureTape(ii + 1, g_nRightCir(1, ii))

                Select Case g_iRightInsertStyle
                    Case 0
                        If g_RightOnFold Then
                            nValue = ((nFiguredValue + RIGHT_EIGHTH) - nInsert) / 2
                        Else
                            nValue = ((nFiguredValue + (3 * RIGHT_EIGHTH)) - (2 * nInsert)) / 2
                        End If
                    Case 1
                        nValue = ((nFiguredValue + (3 * RIGHT_EIGHTH)) - nInsert) / 2
                    Case 2, 3
                        nValue = (nFiguredValue + (2 * RIGHT_EIGHTH)) / 2
                End Select
        ...
        If g_RightExtendTo = RIGHT_GLOVE_ELBOW Or g_RightExtendTo = RIGHT_GLOVE_AXILLA Then
            ...
            iStartTape = g_iRightWristPointer
            iLastTape = g_iRightWristPointer + (g_iRightNumTapesWristToEOS - 1)
            ...
            For ii = iStartTape To iLastTape
                'NB use of 1/2 scale
                ''-----------nFiguredValue = (g_nRightCir(ii) * ((100 - g_iRed(ii)) / 100))
                nFiguredValue = (g_nRightCir(1, ii) * ((100 - g_iRed(ii)) / 100))
                Select Case g_iRightInsertStyle
                    Case 0
                        If g_RightOnFold Then
                            nValue = ((nFiguredValue + RIGHT_EIGHTH) - nInsert) / 2
                ...
                'the drawing side
                RightTapeNote(iVertex).sTapeText = LTrim(Mid(g_sRightTapeText, ((ii + 1) * 3) + 1, 3))
                RightTapeNote(iVertex).iTapePos = ii
                ''------------RightTapeNote(iVertex).nCir = g_nRightCir(ii)
                RightTapeNote(iVertex).nCir = g_nRightCir(1, ii)
                RightTapeNote(iVertex).iGms = g_iGms(ii)
                RightTapeNote(iVertex).iRed = g_iRed(ii)
                RightTapeNote(iVertex).iMMs = g_iMMs(ii)
                ...
                If ii = iStartTape + 1 And g_nRightPleats(1) > 0 Then nSpacing = fnDisplayToInches(g_nRightPleats(1))
                If ii = iStartTape + 2 And g_nRightPleats(2) > 0 Then nSpacing = fnDisplayToInches(g_nRightPleats(2))
                'XXXXXXXXXX
                'XXXX Careful now! this won't work if only 3 or less tapes given
                'XXXXXXXXXX
                'Axilla
                If ii = iLastTape - 1 And g_nRightPleats(3) <> 0 Then nSpacing = fnDisplayToInches(g_nRightPleats(3))
                If ii = iLastTape And g_nRightPleats(4) <> 0 Then nSpacing = fnDisplayToInches(g_nRightPleats(4))
                ...
                If iVertex <> 1 Then
                    ...
                    If nSpacing <> 1.375 Then RightTapeNote(iVertex).sNote = "PLEAT"
                End If
    ...
    End Function
    Sub PR_CalcRightWristBlendingProfile(ByRef xyTSt As XY, ByRef xyTEnd As XY, ByRef xyBSt As XY, ByRef xyBEnd As XY, ByRef ReturnProfile As curve, ByRef xyThumbPalm As XY)
        'Procedure to return a smooth inflecting curve between two points
        '
    ...
    Sub PR_DrawPoly(ByRef Profile As curve, ByRef Bulge As Double())
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acPoly As Polyline = New Polyline()
                ...
                g_idRgtLastZipper = acPoly.ObjectId
                ...
                Using rb As New ResultBuffer
                    ...
                    rb.Add(New TypedValue(DxfCode.ExtendedDataAsciiString, g_sFileNo + "Right"))
                    acPoly.XData = rb
                End Using
            End Using
    ...
    Private Sub PR_DrawSpline(ByRef PointCollection As Point3dCollection)
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Using acSpline As Spline = New Spline(PointCollection, vecTan, vecTan, 4, 0.0)
                ...
                g_idRgtLastZipper = acSpline.ObjectId
                Dim acRegAppTbl As RegAppTable
                acRegAppTbl = acTrans.GetObject(acCurDb.RegAppTableId, OpenMode.ForRead)
                Dim acRegAppTblRec As RegAppTableRecord
                If acRegAppTbl.Has("ID") = False Then
    ...
    Sub PR_AddXDataValToLast(ByRef sDBName As String, ByRef sDBValue As String)
        ...
        If (g_idRgtLastZipper.IsValid = False) Then
            Exit Sub
        End If
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        ...
        '' Start a transaction
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            Dim acEnt As DBObject = acTrans.GetObject(g_idRgtLastZipper, OpenMode.ForWrite)
            Dim acRegAppTbl As RegAppTable
            acRegAppTbl = acTrans.GetObject(acCurDb.RegAppTableId, OpenMode.ForRead)
            Dim acRegAppTblRec As RegAppTableRecord
    ...
    Sub PR_DrawLine(ByRef xyStart As XY, ByRef xyFinish As XY)
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            g_idRgtLastZipper = acLine.ObjectId
            Dim acRegAppTbl As RegAppTable
            acRegAppTbl = acTrans.GetObject(acCurDb.RegAppTableId, OpenMode.ForRead)
            Dim acRegAppTblRec As RegAppTableRecord
            If acRegAppTbl.Has("ID") = False Then
    ...
    Sub PR_DrawShoulderFlaps(ByRef xyS As XY, ByRef xyE As XY, ByRef strFlaps As String, ByRef strCustFlapLength As String,
        ...
        Else
            ...
            ''-------------------LastTapeValue = g_nRightCir(g_iRightEOSPointer)
            LastTapeValue = g_nRightCir(1, g_iRightEOSPointer)
        ...
        PR_MakeXY(xyStrapText, xyMidPoint.X, xyMidPoint.y - (2 * RIGHT_EIGHTH))
        ...
        PR_DrawRightManGlvClosedArrow(xyArrow, 135)
        ''PrintLine(fNum, "SetDBData(hEnt," & QQ & "ID" & QQ & ",sID);")
        PR_AddXDataValToLast("ID", g_sFileNo + "Right")
        ...
        End If
    End Sub
    Sub PR_DrawRightManGlvClosedArrow(ByRef xyPoint As MANGLOVERight_bas.XY, ByRef nAngle As Object)
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        Dim strLayout As String = BlockTableRecord.ModelSpace
        If fnGetSettingsPath("DRAW_IN_LAYOUT").ToUpper().Equals("YES", StringComparison.InvariantCultureIgnoreCase) Then
        ...
        Dim xyStart As MANGLOVERight_bas.XY
    ...
    Sub PR_DrawMarker(ByRef xyPoint As XY)
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            If blkRecId <> ObjectId.Null Then
                ...
                acBlkTblRec.AppendEntity(blkRef)
                acTrans.AddNewlyCreatedDBObject(blkRef, True)
                g_idRgtLastZipper = blkRef.ObjectId
                Dim acRegAppTbl As RegAppTable
                acRegAppTbl = acTrans.GetObject(acCurDb.RegAppTableId, OpenMode.ForRead)
                Dim acRegAppTblRec As RegAppTableRecord
                If acRegAppTbl.Has("ID") = False Then
    ...
    End Sub
    Sub PR_DrawRightGlvTapeNotes(ByRef xyPoint As XY, ByRef sData As String, ByRef sMM As String, ByRef sGrams As String, ByRef sReduction As String,
