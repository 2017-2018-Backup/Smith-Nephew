...
Public Class acadEntry
    ...
    Public Sub Initialize() Implements IExtensionApplication.Initialize
        If Autodesk.AutoCAD.ApplicationServices.Application.Version.Major > 22 Then
            ...
            ed.WriteMessage(vbLf & "SmithNephew.dll is incompatible with this version of AutoCAD")
