Public Class WHZCPANT_frm
    ...
    Public g_sElasticNote As String

    Private Sub WHZCPANT_frm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            Hide()
            ...
            If g_sElasticNote.Equals("NO ELASTIC") = True Then
