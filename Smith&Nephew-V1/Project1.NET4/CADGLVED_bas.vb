...
Module CADGLVED1
	...
	Public xyArcCenter As XY
	Public xyArcStart As XY
	Public nArcRadius As Double
	Public aArcStart As Double
	Public aArcSweep As Double
	...
	Sub PR_CalcWristBlendLFS(ByRef xyArcCen As XY, ByRef aArcSweep As Double, ByRef xyArcStart As XY, ByRef xyBSt As XY, ByRef xyBEnd As XY, ByRef ReturnProfile As Curve)
		...
		'
		Dim nR1, rAngle, aA2, nL3, nL1, nL2, aA1, aA3, aInc, nR2 As Double
		Dim xyBotSt, xyTopSt, xyCenter, xyMidPoint, xyTopEnd, xyBotEnd As XY
		Dim xyR2, xyArc As XY
		Dim nA, nThirdOfL2, aAngle As Double
		Dim xyTEnd, xyPt1, xyPt2, xyArcSt As XY
		Dim TopIsArc, MirrorResult, ii, Direction, BottomIsArc As Short
