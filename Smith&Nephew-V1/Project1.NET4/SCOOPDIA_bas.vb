	...
	Function FN_InchesValue(ByRef TextBox As System.Windows.Forms.Control) As Double
		...
		For nn = 1 To iLen
			...
			If Asc(sChar) > 57 Or Asc(sChar) < 46 Or Asc(sChar) = 47 Then
				MsgBox("Invalid - Dimension has been entered", 48, "Scoop Neck Dialogue")
				TextBox.Focus()
				FN_InchesValue = -1
				Exit For
			End If
		...
		'    If nLen = -1 Then
		'        MsgBox "Invalid - Length has been entered", 48, "Scoop Neck Dialogue"
		'        TextBox.SetFocus
		'        FN_InchesValue = -1
		'    Else
		'        FN_InchesValue = nLen
