...
Friend Class cltxfdia
    ...
    Private Sub OK_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles OK.Click
        ...
        '    'drafix macro
        '    If (System.IO.File.Exists(lblCADFile.Text)) Then
        '        Dim acDocMgr As DocumentCollection = Application.DocumentManager
        '        ' Dim acDoc As Document = DocumentCollectionExtension.Add(acDocMgr, lblCADFile.Text)
        '        Dim acDoc As Document = DocumentCollectionExtension.Open(acDocMgr, lblCADFile.Text, False)
    ...
    Private Sub PR_DRAFIX_Macro(ByRef sDrafixFile As String)
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        FileOpen(CLTXFDIA1.fNum, sDrafixFile, OpenMode.Output)
    ...
    Private Sub txtNamePD_TextChanged(sender As Object, e As EventArgs) Handles txtNamePD.TextChanged
