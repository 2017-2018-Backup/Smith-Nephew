...
Module WHFIGURE1
    ...
    Sub Validate_And_Display_Text_In_Box(ByRef Text_Box_Name As System.Windows.Forms.TextBox, ByRef Grid_Name As System.Windows.Forms.Control, ByRef index As Short)
