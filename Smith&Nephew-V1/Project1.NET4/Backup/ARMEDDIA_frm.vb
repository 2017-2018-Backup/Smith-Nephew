...
Friend Class armeddia
	...
	Private Sub Form_LinkClose()
		...
		If txtArm.Text = "Left" Then
			Me.Text = "ARM Edit - Left [" & g_sFileNo & "]"
		End If
		If txtArm.Text = "Right" Then
			Me.Text = "ARM Edit - Right [" & g_sFileNo & "]"
		End If
		...
		Else
			ARMEDDIA1.PR_LoadFabricFromFile(g_MATERIAL, g_sPathJOBST & "\TEMPLTS\BOBINNET.DAT")
		End If
	...
	Private Sub PR_CancelProfileEdits()
		...
		If g_ReDrawn = True Then
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			fNum = FN_DrawOpen("C:\JOBST\DRAW.D", "EDIT", "Cancel", txtArm)
			
			If g_ShortArm = True Then
				'Restore original curve (Short Arms only)
				BDYUTILS.PR_PutLine("HANDLE  hCurv;")
				'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				PrintLine(fNum, "hCurv = UID (" & QQ & "find" & QC & Val(txtUIDTempArm.Text) & ");")
				For ii = 0 To g_iProfile
					'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					PrintLine(fNum, "SetVertex(hCurv," & ii + 1 & "," & xyOriginal(ii).X & "," & xyOriginal(ii).y & ");")
				Next ii
			Else
				'Delete Curve Copy
				BDYUTILS.PR_PutLine("HANDLE hTempCurv;")
				'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				PrintLine(fNum, "hTempCurv = UID (" & QQ & "find" & QC & Val(txtUIDTempArm.Text) & ");")
				'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_DeleteTapeLabel(ByRef xyPt As XY, ByRef nTape As Object)
		...
		slayer = g_sFileNo & Mid(g_sSide, 1, 1) & nTape
		
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "hChan=Open(" & QQ & "selection" & QCQ & "(type = 'Text' OR type = 'circle') AND layer = '" & slayer & "' AND TOTally INside " & x1 & y1 & x2 & y2 & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_DrawAndCommitProfileEdits()
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		fNum = FN_DrawOpen("C:\JOBST\DRAW.D", "EDIT", "Test", txtArm)
		BDYUTILS.PR_PutLine("HANDLE  hCurv, hTempCurv, hArm, hChan, hEnt;")
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "hCurv = UID (" & QQ & "find" & QC & Val(txtUIDCurve.Text) & ");")
		...
		If ProfileChanged = True Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PrintLine(fNum, "hArm = UID (" & QQ & "find" & QC & Val(txtUIDArm.Text) & ");")
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PrintLine(fNum, "if (!hArm)Exit(%cancel," & QQ & "Can't find ARMBOX to Update" & QQ & ");")
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PrintLine(fNum, "SetDBData( hArm, " & QQ & "TapeLengths" & QCQ & sPackedLengths & QQ & ");")
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_DrawContracture()
		Dim xyContractTop, xyContractBott As XY
	...
	Private Sub PR_DrawProfileEdits()
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		fNum = FN_DrawOpen("C:\JOBST\DRAW.D", "EDIT", "Profile Edits", txtArm)
		BDYUTILS.PR_PutLine("HANDLE  hCurv;")
		...
		If g_ReDrawn <> True And g_ShortArm = False Then
			...
			For ii = 0 To g_iProfile
				'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				Print(fNum, cc & xyProfile(ii).X & cc & xyProfile(ii).y)
			Next ii
		...
		If g_ReDrawn <> True And g_ShortArm = False Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PrintLine(fNum, "hDDE = Open (" & QQ & "dde" & QCQ & "armeddia" & QCQ & "armeddia" & QQ & ");")
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PrintLine(fNum, "Poke ( hDDE, " & QQ & "txtUIDTempArm" & QC & "MakeString(" & QQ & "long" & QC & "UID(" & QQ & "get" & QQ & ",hCurv)));")
	...
	Private Sub PR_GetProfileFromFile(ByRef sFileName As String)
		...
		If g_Gauntlet Then
			...
			For ii = g_iWristNo To g_iLastTape
				g_iVertexMap(ii) = iVertex
				iVertex = iVertex + 1
			Next ii
