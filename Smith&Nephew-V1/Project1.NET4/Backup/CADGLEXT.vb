...
Module CADGLEXT
	...
	Sub PR_CalculateExtension()
		...
		If g_ExtendTo = GLOVE_ELBOW Or g_ExtendTo = GLOVE_AXILLA Then
			...
			BDYUTILS.PR_CalcMidPoint(xyPalm(1), xyPalm(6), xyPalm(7))
	...
	Sub PR_CalcWristBlendLFS(ByRef xyArcCen As XY, ByRef aArcSweep As Double, ByRef xyArcStart As XY, ByRef xyBSt As XY, ByRef xyBEnd As XY, ByRef ReturnProfile As Curve)
		...
		'used as xyTEnd
		aAngle = ARMDIA1.FN_CalcAngle(xyArc, xyArcSt) + ((aArcSweep * 3) / 4)
		nRadius = ARMDIA1.FN_CalcLength(xyArc, xyArcSt)
		ARMDIA1.PR_CalcPolar(xyArc, aAngle, nRadius, xyTopEnd)
		...
		If ARMDIA1.FN_CalcAngle(xyBSt, xyTEnd) = ARMDIA1.FN_CalcAngle(xyBEnd, xyBSt) Then
			ReturnProfile.n = 2
		...
		aAngle = ARMDIA1.FN_CalcAngle(xyArc, xyArcSt)
		aInc = aArcSweep / 4
		For ii = 2 To 4
			aAngle = aAngle + aInc
			ARMDIA1.PR_CalcPolar(xyArc, aAngle, nRadius, xyTmp(ii))
		Next ii
		...
		ARMDIA1.PR_CalcPolar(xyBotSt, ARMDIA1.FN_CalcAngle(xyBotSt, xyTopEnd), nThirdOfL2, xyTmp(5))
		ARMDIA1.PR_CalcPolar(xyBotSt, ARMDIA1.FN_CalcAngle(xyBotSt, xyBotEnd), nThirdOfL2, xyTmp(8))
		...
		Else
			aAngle = ARMDIA1.FN_CalcAngle(xyBotSt, xyTopEnd) + 90
		End If
		ARMDIA1.PR_CalcPolar(xyTmp(5), aAngle, nR2, xyR2)
		...
		'Bottom arc points
		aAngle = ARMDIA1.FN_CalcAngle(xyR2, xyTmp(5))
		aA1 = ARMDIA1.FN_CalcAngle(xyR2, xyTmp(8))
	...
	Sub PR_CalcWristBlendThumbSide(ByRef xyTSt As XY, ByRef xyTEnd As XY, ByRef xyBSt As XY, ByRef xyBEnd As XY, ByRef ReturnProfile As Curve)
		...
		nL1 = ARMDIA1.FN_CalcLength(xyBSt, xyTEnd) / 3
		aAngle = ARMDIA1.FN_CalcAngle(xyBSt, xyTEnd)
		
		BDYUTILS.PR_CalcMidPoint(xyTSt, xyTEnd, xyTmp)
		...
		For ii = 5 To 4 Step -1
			nL = nL + nL1
			ARMDIA1.PR_CalcPolar(xyBSt, aAngle, nL, xyTmp)
