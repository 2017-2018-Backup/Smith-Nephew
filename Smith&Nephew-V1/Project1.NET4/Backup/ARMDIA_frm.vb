...
Friend Class armdia
		...
		If g_Modified Then
			...
			Select Case Response
				Case IDYES
					...
					fNum = ARMDIA1.FN_Open("c:\jobst\draw.d", txtPatientName, txtFileNo, txtSleeve, "Save")
					'Check Flaps
					txtFlap.Text = cboFlaps.Text
	...
	Private Function cmtoinches(ByRef flag As Object, ByRef cm As Object) As Object
	...
	Private Sub Draw_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Draw.Click
		...
		Dim conures, Profile, Gauntend As curve
		Dim tps, ii, nn, numtapes As Object
		Dim fNum As Short
		Dim xyPleat, xyThumbhole, xyFin, xyMidPoint, xyTHole1, xyPt, xyPt1, xyCen, xyBegin, xyTHole2, xyPt2, xyElbow1 As XY
		...
		Dim xyThumb7, xyThumb5, xyThumb3, xyThumb1, xyThumbStart, xyThumb2, xyThumb4, xyThumb6, xyThumb8 As XY
		Dim nTextHt, thmAng1, thm2, thm1, thm3, thmang2, numtap As Object
		Dim xyP As XY
		Dim w, SeamDist, X As Object
		Dim v As Short
		Dim xyElbMark1, xyElbMark2 As XY
		...
		ARMDIA1.PR_AddEntityID(g_sID, "", "Profile") 'g_sID from FN_Open
		PrintLine(fNum, "SetDBData(hEnt," & QQ & "curvetype" & QCQ & "sleeveprofile" & QQ & ");")
		...
		ARMDIA1.PR_AddEntityID(g_sID, "", "FoldLine") 'sFileNo, sSide from FN_Open
		...
		If txtGauntletFlag.Text = "False" Then
			...
			ARMDIA1.PR_AddEntityID(g_sID, "", "WristLine") 'sFileNo, sSide from FN_Open
		...
		If cboFlaps.Text = "" Or cboFlaps.Text = " " Then
			...
			ARMDIA1.PR_AddEntityID(g_sID, "", "ShoulderLine") 'sFileNo, sSide from FN_Open
		...
		Else
			g_sFlap = cboFlaps.Text
			CADGLEXT.PR_DrawShoulderFlaps(Profile, numtapes)
		End If
	...
	Private Sub DrawGauntlet(ByRef Profile As curve, ByRef numtapes As Object)
		Dim Ydiff As Object
		...
		'UPGRADE_WARNING: Arrays in structure Gauntend may need to be initialized before they can be used. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"'
		Dim Gauntend, GauntDetachEnd As curve
		Dim xyCen, xyPt1, xyTHole1, xyMidPoint As XY
		Dim xyThumbConstruct1, xyThumbConstruct2 As XY
		Dim lenty, hole, GauntSize, nPalm, nTextHt As Object
		Dim num, nlen, nAdj2, nOpp2, nOpp1, nAdj1, nAng1, midylen, Ext As Object
		Dim xyThumbhole, xyFin, xyBegin, xyTHole2, xyPt2 As XY
		Dim xyGend1, xyGend2 As XY
		Dim tps, ii, nn, fNum As Object
		Dim xyPt, xyPleat As XY
		Dim xyElbow3, xyElbow1, xyElbow2, xyElbow4 As XY
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		'UPGRADE_WARNING: Couldn't resolve default property of object GauntSize. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		If Val(txtGauntletExtension.Text) > 0 Then GauntSize = cmtoinches(txtinchflag, txtGauntletExtension)
		...
		ARMDIA1.PR_AddEntityID(g_sID, "", "GauntEnd") 'sFileNo, sSide from FN_Open
		...
		ARMDIA1.PR_AddEntityID(g_sID, "", "ThumbHoleConstruct") 'g_sID from FN_Open
		...
		ARMDIA1.PR_AddEntityID(g_sID, "", "ThumbHole") 'g_sID from FN_Open
	...
	Private Sub DrawThumb(ByRef xyThumbhole As XY)
		Dim nOpp2 As Object
		Dim nAdj2 As Object
		Dim nAng2 As Object
		Dim nlen As Object
		...
		Dim lenty As Object
		Dim xyThumb7, xyThumb5, xyThumb3, xyThumb1, xyThumbStart, xyThumb2, xyThumb4, xyThumb6, xyThumb8 As XY
		Dim xyThumbBase3, xyThumbBase1, xyThumbBase2, xyThumbBase4 As XY
		Dim thmang2, thm3, thm1, thm2, thmAng1, nTextHt As Object
		Dim xyCen, xyBegin, xyFin, xyMidPoint, xyPt As XY
		...
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbLength") 'sFileNo, sSide from FN_Open
		
		' thumb tip
		If chkEnclosed.CheckState = 0 Then
			ARMDIA1.PR_DrawLine(xyThumb3, xyThumb4)
			ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbCircum") 'sFileNo, sSide from FN_Open
		ElseIf chkEnclosed.CheckState = 1 Then 
			ThumbTip(xyThumb3, xyThumb4)
			ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbCircum") 'sFileNo, sSide from FN_Open
		End If
		ARMDIA1.PR_DrawLine(xyThumb4, xyThumb5)
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbBack") 'sFileNo, sSide from FN_Open
		ARMDIA1.PR_DrawLine(xyThumb5, xyThumb6)
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbBack2") 'sFileNo, sSide from FN_Open
		
		'Draw base of thumb
		ARMDIA1.PR_DrawLine(xyThumb7, xyThumb8)
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumBase") 'sFileNo, sSide from FN_Open
		...
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbRightCurve") 'sFileNo, sSide from FN_Open
		...
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbLeftCurve") 'sFileNo, sSide from FN_Open
		...
		ARMDIA1.PR_DrawArc(xyCen, xyBegin, xyFin)
		ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "ThumbJCurve") 'sFileNo, sSide from FN_Open
	...
	Private Sub Elastic(ByRef Profile As curve)
		...
		Dim elastictop As curve
		Dim xyEpt2, xyEpt1, xyEpt3 As XY
	...
	Private Sub Form_LinkClose()
		...
		Else
			...
			If nValue > 0 Then
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				labStrap.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtStrap))
			End If
			'UPGRADE_WARNING: Couldn't resolve default property of object sData. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			If nValue > 0 Then
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				labCustFlapLength.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtCustFlapLength))
			End If
			'UPGRADE_WARNING: Couldn't resolve default property of object sData. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			If nValue > 0 Then
				...
				g_sWaistCir = nValue
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				labWaistCir.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtWaistCir))
			End If
			'UPGRADE_WARNING: Couldn't resolve default property of object sData. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			If nValue > 0 Then
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				labFrontStrapLength.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtFrontStrapLength))
			End If
		...
		If Val(txtGauntletExtension.Text) > 0 Then
			'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			labGauntletExtension.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtGauntletExtension))
		End If
	...
	Private Sub armdia_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		fileNum = FreeFile
		'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		FileOpen(fileNum, g_sPathJOBST & "\Defaults\Pressure.dat", OpenMode.Input)
		'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		fileNum = FreeFile
		'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		FileOpen(fileNum, g_sPathJOBST & "\Defaults\flaps.dat", OpenMode.Input)
		'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		Do While Not EOF(fileNum)
			'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			textline = LineInput(fileNum)
		...
		fileNum = FreeFile
		'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		FileOpen(fileNum, g_sPathJOBST & "\templts\bobinnet.dat", OpenMode.Input)
		For i = 1 To 19
			'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		fileNum = FreeFile
		'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		FileOpen(fileNum, g_sPathJOBST & "\templts\powernet.dat", OpenMode.Input)
		For P = 1 To 19
			'UPGRADE_WARNING: Couldn't resolve default property of object fileNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Function PadGram(ByRef Gram As Object) As Object
		'UPGRADE_WARNING: Couldn't resolve default property of object Gram. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		If Gram <> "" Then
			'UPGRADE_WARNING: Couldn't resolve default property of object Gram. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			If Val(Gram) < 10 Then
	...
	Private Function PadMM(ByRef mm As Object) As Object
	...
	Private Function PadRed(ByRef red As Object) As Object
	...
	Private Sub PR_AddMarker(ByRef xyInsert As XY)
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "hEnt = AddEntity(" & QQ & "marker" & QCQ & "xmarker" & QC)
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, 0.1 & CC & 0.1 & CC & 0 & ");")
	End Sub
		...
		Do While X < 19
			...
			Do While w < 18
				...
				If (Length(Index).Text <> "" And mms(Index).Text = "") Or (Length(Index).Text <> "" And g_sPressureChange = "True") Then
					CADGLEXT.PR_SetMMs(w, g_sAmm, g_sBmm, g_sCmm, g_sDmm)
				End If
				PR_Reductions(w, X)
				PR_WristRed(w, X, g_sModulus)
				PR_PalmRed(w, X, g_sModulus)
			...
			If chkDetachable.CheckState = 1 Then
				...
				ElseIf X = Val(txtWristNo.Text) And X = Val(txtLastTape.Text) Then 
					...
					If Length(w + 1).Text = "" Then
						...
						'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						'UPGRADE_WARNING: Couldn't resolve default property of object w. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						InchText(w + 1).Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, Length(w)))
						reds(w).Text = CStr(10)
						'UPGRADE_WARNING: Couldn't resolve default property of object fabnam. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						If VB.Left(fabnam, 3) = "Pow" Then
							'UPGRADE_WARNING: Couldn't resolve default property of object Modul. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_DrawShoulderFlaps(ByRef Profile As curve, ByRef numtapes As Object)
		Dim Strap As Object
		...
		Dim ShoulderFlap, RaglanFlap As curve
		Dim LastTapeValue As Object
		Dim xyPt1, xyPt2 As XY
		Dim xyTopFlap4, xyTopFlap2, xyTopFlap1, xyTopFlap3, xyTopFlap5 As XY
		Dim xyTopFlap9, xyTopFlap7, xyTopFlap6, xyTopFlap8, xyTopFlap10 As XY
		Dim xyBotFlap4, xyBotFlap2, xyBotFlap1, xyBotFlap3, xyBotFlap5 As XY
		Dim xyPotA, xyFlap4, xyFlap2, xyFlap1, xyFlap3, xyFlap5, xyPotB As XY
		...
		Dim xyFlapText1 As XY
		Dim xyFlapText2, xyCentre, xyMid, xyFlapMarker, xyStrapText As XY
		...
		Dim Arrow As String
		Dim xyRaglan6, xyRaglan4, xyRaglan2, xyRaglan1, xyRaglan3, xyRaglan5, xyRaglan7 As XY
		...
		If txtFlap.Text <> "" And txtFlap.Text <> "Vest" And txtFlap.Text <> "Body" Then
			...
			ARMDIA1.PR_SetLayer("Notes")
			'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PrintLine(fNum, "hEnt = AddEntity(" & QQ & "marker" & QCQ & "closed arrow" & QC & "xyStart.x +" & Str(xyFlapMarker.X) & CC & "xyStart.y +" & Str(xyFlapMarker.y) & ",0.25,0.1,225);")
			ARMDIA1.PR_SetLayer("Template" & txtSleeve.Text)
			...
			Strap = "STRAP = " & Trim(ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtStrap))) & "\" & QQ
			If Val(txtFrontStrapLength.Text) > 0 Then
				'Display FRONT strap length if given
				'UPGRADE_WARNING: Couldn't resolve default property of object QQ. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object Strap. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				Strap = "BACK  STRAP = " & Trim(ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtStrap))) & "\" & QQ
				'UPGRADE_WARNING: Couldn't resolve default property of object QQ. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object Strap. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				Strap = Strap & "\nFRONT STRAP = " & Trim(ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtFrontStrapLength))) & "\" & QQ
			End If
			If Val(txtWaistCir.Text) > 0 Then
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object Strap. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				Strap = Strap & "\nWAIST = " & Trim(ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtWaistCir))) & "\" & QQ
			End If
			...
			Else
				ARMDIA1.PR_DrawLine(xyPt1, xyPt2) 'Fold Line
			End If
			ARMDIA1.PR_AddEntityID(g_sFileNo, g_sSide, "FoldLineFlap") 'sFileNo, sSide from FN_Open
	...
	Private Sub PR_GetStartEndTapes()
		...
		If g_iStyleFirstTape > g_iFirstTape And g_iStyleFirstTape >= 0 And cboDistalTape.SelectedIndex <> 0 Then
		...
		Else
			txtFirstTape.Text = CStr(g_iFirstTape)
			'UPGRADE_WARNING: Couldn't resolve default property of object g_iSecondTape. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		If g_iStyleLastTape < g_iLastTape And g_iStyleLastTape >= 0 And cboProximalTape.SelectedIndex <> 0 Then
		...
		Else
			txtLastTape.Text = CStr(g_iLastTape)
			'UPGRADE_WARNING: Couldn't resolve default property of object g_iSecondLastTape. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_OldDrawing()
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "Flap" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "Gauntlet" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "Stump" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "TapeLengths" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "TapeMMs" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "Reduction" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		PrintLine(fNum, "Table(" & QQ & "add" & QCQ & "field" & QCQ & "Grams" & QCQ & "string" & QQ & ");")
		'UPGRADE_WARNING: Couldn't resolve default property of object fNum. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_PalmRed(ByRef w As Object, ByRef X As Object, ByRef Modulus As Object)
		...
		If Length(w).Text <> "" Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object w. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_WARNING: Couldn't resolve default property of object X. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			If (chkGauntlets.Checked = True And X = txtPalmNo.Text) Or (chkGauntlets.Checked = True And w = (CDbl(txtFirstTape.Text) - 1)) Then
				
				reds(w).Text = CStr(15)
				
				If VB.Left(g_sFabnam, 3) = "Pow" Then
					'UPGRADE_WARNING: Couldn't resolve default property of object Modulus. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object Pow(Modulus, 6). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object Backgram. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					Backgram = Pow(Modulus, 6)
				Else
					'UPGRADE_WARNING: Couldn't resolve default property of object Modulus. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object Bob(Modulus, 6). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object Backgram. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub PR_SetGlobals()
		...
		g_sSide = txtSleeve.Text
		'UPGRADE_WARNING: Couldn't resolve default property of object g_sWaistCir. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		g_sWaistCir = txtWaistCir.Text
		
	End Sub
	
	Private Sub PR_SetMMs(ByRef w As Object, ByRef Amm As Object, ByRef Bmm As Object, ByRef Cmm As Object, ByRef Dmm As Object)
	...
	Private Sub ThumbTip(ByRef xyArcStart As XY, ByRef xyArcEnd As XY)
		Dim nOpp As Object
		Dim nAdj As Object
	...
	Private Sub txtCircum_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCircum.Leave
		...
		ElseIf Val(txtCircum.Text) > 0 Then 
			'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			TCirc.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtCircum))
		Else
			TCirc.Text = ""
		End If
	End Sub
	...
	Private Sub txtPalmWrist_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtPalmWrist.Leave
		...
		ElseIf Val(txtPalmWrist.Text) > 0 Then 
			'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PWDist.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtPalmWrist))
		Else
			PWDist.Text = ""
		End If
	End Sub
	...
	Private Sub txtStrapLength_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtStrapLength.Leave
		...
		ElseIf Val(txtStrapLength.Text) > 0 Then 
			'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			labStrap.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtStrapLength))
	...
	Private Sub txtThumb_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtThumb.Leave
		...
		ElseIf Val(txtThumb.Text) > 0 Then 
			'UPGRADE_WARNING: Couldn't resolve default property of object cmtoinches(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			TLen.Text = ARMEDDIA1.fnInchesToText(cmtoinches(txtinchflag, txtThumb))
		Else
			TLen.Text = ""
		End If
	End Sub
	...
	Private Sub TypeDetails(ByRef Profile As curve, ByRef numtapes As Object)
