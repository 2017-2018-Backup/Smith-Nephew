...
Module WHFIGURE1
	...
	Public MainForm As whfigure
	
	'Globals
	Public g_nUnitsFac As Double
	Public g_iLtAnkle As Short
	Public g_iRtAnkle As Short
	Public g_JOBSTEX As Short
	Public g_JOBSTEX_FL As Short
	Public g_POWERNET As Short
	
	'Globals used to transfer data to WHFIGBRF.FRM
	'for use in restricted fabric selection for BRIEFs
	Public g_sLastFabric As String
	Public g_sDiagnosis As String
	Public g_iUidBody As Short
	...
	Public g_iRtLastFabric As Short
	
	Public g_nRtLastHeel As Double
	Public g_nRtLastAnkle As Double
	Public g_iRtLastMM As Double
	Public g_iRtLastStretch As Short
	Public g_iRtLastZipper As Short
	
	Public g_iRtStretch(29) As Short
	Public g_iRtRed(29) As Short
	Public g_iRtMM(29) As Short
	...
	Sub Validate_And_Display_Text_In_Box(ByRef Text_Box_Name As System.Windows.Forms.Control, ByRef Grid_Name As System.Windows.Forms.Control, ByRef index As Short)
		...
		If index >= 0 Then
			'UPGRADE_WARNING: Couldn't resolve default property of object Grid_Name.Row. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Grid_Name.Row = index
			Grid_Name.Text = fnInchesToText(rTextBoxValue)
		End If
